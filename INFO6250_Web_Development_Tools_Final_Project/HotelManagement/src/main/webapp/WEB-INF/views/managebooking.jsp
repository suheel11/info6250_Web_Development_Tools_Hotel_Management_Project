				...
				<ul id="sortable">
					...
					<li><div class="media">
							<div class="media-left align-self-center">
								<img class="rounded-circle" src="https://health.arlingtonva.us/wp-content/uploads/sites/25/2013/12/hotel.jpg">
							</div>
							...
							<div class="media-right align-self-center">
								<a href="/myapp/deleteBooking/?id='${booking.getId()}'" class="btn btn-default">Cancel</a>
							</div>
						</div></li>
					</c:forEach>
			</div>
